              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type="text" inputMode="email" autoComplete="email" placeholder="name@gmail.com" maxLength={EMAIL_MAX_LENGTH} className="border-white/10 bg-secondary/50 focus-visible:ring-primary/40 pl-11 h-11 text-sm rounded-xl" value={email} onChange={(e) => setEmail(sanitizeEmailInput(e.target.value))}/>
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type={showPassword ? "text" : "password"} maxLength={30} placeholder="••••••••" className="border-white/10 bg-secondary/50 focus-visible:ring-primary/40 pl-11 pr-11 h-11 text-sm rounded-xl" value={password} onChange={(e) => setPassword(e.target.value)}/>
