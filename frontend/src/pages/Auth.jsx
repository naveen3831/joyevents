...
import { sanitizeEmailInput, sanitizeNameInput, validateLoginForm, validateSignupForm, NAME_MAX_LENGTH, NAME_HINT, EMAIL_HINT, PASSWORD_HINT, EMAIL_MAX_LENGTH, } from "@/lib/validation";
const Auth = () => {
