...
import { Sparkles, Calendar, MapPin, DollarSign, FileText, Users, ArrowLeft, Loader2, Tag } from "lucide-react";
...
export default function RequestCustomServicePage() {
  ...
  return (
    <CustomerLayout>
      <section className="py-4 sm:py-6 max-w-4xl mx-auto space-y-6">
        {/* Navigation & Page Header */}
        <div>
          <button
            type="button"
            onClick={() => navigate("/customer-dashboard/bookings")}
            className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-primary transition-colors mb-3"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground mt-0.5 font-normal">
        ...
        {/* Main Form Card */}
        <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card p-5 sm:p-7 shadow-sm space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Service Title (Full Width) */}
            <div className="md:col-span-2">
              <Label htmlFor="serviceTitle" className="text-sm font-semibold text-foreground mb-1.5 block">
            ...
            {/* Category */}
            <div>
              <Label htmlFor="category" className="text-sm font-semibold text-foreground mb-1.5 flex items-center gap-1.5">
            ...
            {/* Event Date */}
            <div>
              <Label htmlFor="eventDate" className="text-sm font-semibold text-foreground mb-1.5 flex items-center gap-1.5">
            ...
            {/* Location / City */}
            <div>
              <Label htmlFor="location" className="text-sm font-semibold text-foreground mb-1.5 flex items-center gap-1.5">
            ...
            {/* Count / Quantity */}
            <div>
              <Label htmlFor="quantity" className="text-sm font-semibold text-foreground mb-1.5 flex items-center gap-1.5">
            ...
            {/* Budget (Optional) */}
            <div className="md:col-span-2">
              <Label htmlFor="budget" className="text-sm font-semibold text-foreground mb-1.5 flex items-center gap-1.5">
                <DollarSign className="h-4 w-4 text-primary" /> Budget in ₹ (Optional)
              </Label>
              <Input
                id="budget"
                type="text"
            ...
            <div className="md:col-span-2">
              ...
              <Textarea
                ...
                required
                maxLength={1000}
                className="rounded-xl bg-background border-border focus:ring-2 focus:ring-primary min-h-[110px] resize-y text-sm"
          ...
          <div className="pt-4 border-t border-border flex flex-col-reverse sm:flex-row items-center justify-end gap-3">
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full sm:w-auto h-11 px-6 rounded-xl font-semibold border-border hover:bg-secondary"
              onClick={() => navigate("/customer-dashboard/bookings")}
              disabled={submitting}
            >
              Cancel
            ...
            <Button
              ...
              disabled={submitting}
              size="lg"
              className="w-full sm:w-auto bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow h-11 px-8 rounded-xl font-semibold"
            >
              {submitting ? (
                <>
