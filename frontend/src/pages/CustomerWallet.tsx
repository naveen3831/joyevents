...
import {
  Wallet, ArrowUpRight, ArrowDownLeft, Landmark, Plus, Loader2, History
} from "lucide-react";
...
const CustomerWallet = () => {
  ...
  const [depositMethod, setDepositMethod] = useState<"card" | "upi">("card");
          ...
          <form onSubmit={handleDepositSubmit} className="space-y-4 pt-2">
            <div>
              ...
              <Input
                ...
                required
                className="bg-secondary border-border w-full mt-1.5"
              />
            </div>
