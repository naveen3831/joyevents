              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input type="password" placeholder="Min. 8 characters" className="border-border bg-secondary pl-10" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} required/>
                  </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground"/>
                    <Input type="password" placeholder="Repeat password" className="border-border bg-secondary pl-10" value={confirm} onChange={(e) => setConfirm(e.target.value)} required/>
                  </div>
                </div>
