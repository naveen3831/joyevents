    ...
    return (<AdminLayout>
      <section className="py-8 max-w-4xl mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
          ...
          {loading ? (<div className="flex items-center justify-center py-20 text-muted-foreground">
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="heroTitle" required maxLength={100} value={heroTitle} onChange={(e) => setHeroTitle(e.target.value)} placeholder="e.g. Create Unforgettable Moments" className="bg-secondary"/>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="heroSubtitle" required maxLength={500} rows={4} value={heroSubtitle} onChange={(e) => setHeroSubtitle(e.target.value)} placeholder="e.g. From intimate workshops to grand festivals..." className="bg-secondary"/>
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="aboutTitle" required maxLength={100} value={aboutTitle} onChange={(e) => setAboutTitle(e.target.value)} placeholder="e.g. We build unforgettable event experiences" className="bg-secondary"/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="aboutExperience" maxLength={20} value={aboutExperience} onChange={(e) => setAboutExperience(e.target.value)} placeholder="e.g. 12+" className="bg-secondary"/>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="aboutSubtitle">About Us Subtitle / Description *</Label>
                    <Textarea id="aboutSubtitle" required maxLength={500} rows={3} value={aboutSubtitle} onChange={(e) => setAboutSubtitle(e.target.value)} placeholder="Describe the company mission and goals..." className="bg-secondary"/>
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input id="portfolioTitle" required maxLength={100} value={portfolioTitle} onChange={(e) => setPortfolioTitle(e.target.value)} placeholder="e.g. A portfolio shaped by atmosphere, scale, and detail" className="bg-secondary"/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input id="portfolioCategories" maxLength={5} value={portfolioCategories} onChange={(e) => setPortfolioCategories(e.target.value)} placeholder="e.g. 12+" className="bg-secondary"/>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="portfolioSubtitle">Portfolio Subtitle / Description *</Label>
                    <Textarea id="portfolioSubtitle" required maxLength={500} rows={3} value={portfolioSubtitle} onChange={(e) => setPortfolioSubtitle(e.target.value)} placeholder="Describe the portfolio summary..." className="bg-secondary"/>
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="eventsCount" maxLength={5} value={eventsCount} onChange={(e) => setEventsCount(e.target.value)} placeholder="e.g. 1,800" className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="attendeesCount">Attendees Count</Label>
                    <Input id="attendeesCount" maxLength={5} value={attendeesCount} onChange={(e) => setAttendeesCount(e.target.value)} placeholder="e.g. 50K+" className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="merchantsCount">Merchants Count</Label>
                    <Input id="merchantsCount" maxLength={5} value={merchantsCount} onChange={(e) => setMerchantsCount(e.target.value)} placeholder="e.g. 340+" className="bg-secondary"/>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="contactPhone" maxLength={12} value={contactPhone} onChange={(e) => setContactPhone(e.target.value.replace(/[^0-9]/g, "").slice(0, 12))} placeholder="e.g. 919876543210" className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="contactAddress" maxLength={150} value={contactAddress} onChange={(e) => setContactAddress(e.target.value)} placeholder="e.g. Mumbai, India" className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                    ...
                    <Input id="contactWorkingHours" maxLength={100} value={contactWorkingHours} onChange={(e) => setContactWorkingHours(e.target.value)} placeholder="e.g. Mon–Fri, 9am–6pm IST" className="bg-secondary"/>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card/50 backdrop-blur p-6 sm:p-8 space-y-4 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="heroImage" maxLength={500} value={heroImage} onChange={(e) => setHeroImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                    ...
                    <Input id="eventsImage" maxLength={500} value={eventsImage} onChange={(e) => setEventsImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="servicesImage" maxLength={500} value={servicesImage} onChange={(e) => setServicesImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                    ...
                    <Input id="aboutImage" maxLength={500} value={aboutImage} onChange={(e) => setAboutImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="portfolioImage" maxLength={500} value={portfolioImage} onChange={(e) => setPortfolioImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                    ...
                    <Input id="contactImage" maxLength={500} value={contactImage} onChange={(e) => setContactImage(e.target.value)} placeholder="Enter image URL..." className="bg-secondary"/>
                  </div>
                </div>
              </div>
