          ...
          <div className="px-3 sm:px-6 lg:px-12 mt-16 pt-12 pb-16 border-t border-border w-full relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-8 lg:grid-cols-4">
              {relatedServices.map((r) => (
                <div
                  key={r._id}
                  onClick={() => navigate(`/services/${r._id}`)}
                  className="group rounded-2xl border border-border bg-card overflow-hidden flex flex-col hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 pointer-events-auto cursor-pointer"
                >
