...
const CustomerSidebar = ({ open, onClose, onToggle }) => {
    ...
    return (<>
      ...
      <aside className="hidden lg:flex flex-col w-56 xl:w-64 border-r border-border bg-card/95 backdrop-blur-xl shrink-0 sticky top-16 h-[calc(100vh-4.5rem)] shadow-sm font-sans rounded-2xl my-2 ml-0">
