...
const LocationPicker = ({ onLocationSelect, initialLat, initialLng }) => {
    ...
    const centerPosition = initialLat && initialLng
        ? [initialLat, initialLng]
        : defaultCenter;
    return (<div className="relative">
      <MapContainer center={centerPosition} zoom={5} style={{ height: '400px', width: '100%', borderRadius: '12px' }} scrollWheelZoom={true} className="z-0">
