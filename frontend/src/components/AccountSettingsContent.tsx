...
const AccountSettingsContent = ({ backLink, formatRole = defaultFormatRole }: AccountSettingsContentProps) => {
  ...
  return (
    <section className="py-2 sm:py-8 lg:py-10">
      <div className="container mx-auto max-w-2xl">
        {backLink && (
          <Link to={backLink.to} className="mb-6 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary">
            {backLink.label}
          </Link>
        )}
