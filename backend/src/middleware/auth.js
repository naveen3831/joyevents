...
export async function verifyToken(req, res, next) {
  try {
    ...
    const user = await User.findById(payload.sub).select("_id name email role status mobile avatar merchantStatus merchantDetails quotationAmount maxEvents maxServices walletBalance referralCode");
