...
class MerchantShell extends StatelessWidget {
  ...
  int _calculateSelectedIndex(BuildContext context) {
    ...
    if (location.startsWith('/merchant/events')) return 1;
    if (location.startsWith('/merchant/services')) return 2;
    if (location.startsWith('/merchant/bookings')) return 3;
    if (location.startsWith('/merchant/profile')) return 4;
    return 0;
  }
  ...
  void _onItemTapped(int index, BuildContext context) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        context.go('/merchant/events');
        break;
      case 2:
        context.go('/merchant/services');
        break;
      case 3:
